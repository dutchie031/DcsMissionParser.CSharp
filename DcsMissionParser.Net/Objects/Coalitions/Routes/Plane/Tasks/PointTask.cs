...
[JsonDerivedType(typeof(ComboTask), nameof(ComboTask))]
[JsonDerivedType(typeof(Mission), nameof(Mission))]
[JsonDerivedType(typeof(ControlledTask), nameof(ControlledTask))]
[JsonDerivedType(typeof(WrappedAction), nameof(WrappedAction))]
[JsonDerivedType(typeof(AttackGroupTask), nameof(AttackGroupTask))]
[JsonDerivedType(typeof(AttackUnitTask), nameof(AttackUnitTask))]
[JsonDerivedType(typeof(BombingTask), nameof(BombingTask))]
[JsonDerivedType(typeof(StrafingTask), nameof(StrafingTask))]
[JsonDerivedType(typeof(CarpetBombingTask), nameof(CarpetBombingTask))]
[JsonDerivedType(typeof(AttackMapObjectTask), nameof(AttackMapObjectTask))]
[JsonDerivedType(typeof(BombingRunwayTask), nameof(BombingRunwayTask))]
[JsonDerivedType(typeof(OrbitTask), nameof(OrbitTask))]
[JsonDerivedType(typeof(RefuelingTask), nameof(RefuelingTask))]
[JsonDerivedType(typeof(FollowTask), nameof(FollowTask))]
[JsonDerivedType(typeof(FollowBigFormationTask), nameof(FollowBigFormationTask))]
[JsonDerivedType(typeof(EscortTask), nameof(EscortTask))]
[JsonDerivedType(typeof(RecoveryTankerTask), nameof(RecoveryTankerTask))]
[JsonDerivedType(typeof(ScriptTask), nameof(ScriptTask))]
[JsonDerivedType(typeof(SetCallsignTask), nameof(SetCallsignTask))]
[JsonDerivedType(typeof(SetFrequencyTask), nameof(SetFrequencyTask))]
[JsonDerivedType(typeof(SetFrequencyForUnitTask), nameof(SetFrequencyForUnitTask))]
[JsonDerivedType(typeof(SwitchWaypointTask), nameof(SwitchWaypointTask))]
[JsonDerivedType(typeof(SwitchActionTask), nameof(SwitchActionTask))]
[JsonDerivedType(typeof(SetInvisibleTask), nameof(SetInvisibleTask))]
[JsonDerivedType(typeof(SetImmortalTask), nameof(SetImmortalTask))]
[JsonDerivedType(typeof(SetUnlimitedFuelTask), nameof(SetUnlimitedFuelTask))]
[JsonDerivedType(typeof(ActivateBeaconTask), nameof(ActivateBeaconTask))]
[JsonDerivedType(typeof(DeactivateBeaconTask), nameof(DeactivateBeaconTask))]
[JsonDerivedType(typeof(EPLRSTask), nameof(EPLRSTask))]
[JsonDerivedType(typeof(StartTask), nameof(StartTask))]
[JsonDerivedType(typeof(TransmitMessageTask), nameof(TransmitMessageTask))]
[JsonDerivedType(typeof(StopTransmissionTask), nameof(StopTransmissionTask))]
[JsonDerivedType(typeof(SmokeOnOffTask), nameof(SmokeOnOffTask))]
[JsonDerivedType(typeof(EngageTargetsTask), nameof(EngageTargetsTask))]
[JsonDerivedType(typeof(EngageTargetsInZoneTask), nameof(EngageTargetsInZoneTask))]
[JsonDerivedType(typeof(EngageGroupTask), nameof(EngageGroupTask))]
[JsonDerivedType(typeof(EngageUnitTask), nameof(EngageUnitTask))]
[JsonDerivedType(typeof(AWACSTask), nameof(AWACSTask))]
[JsonDerivedType(typeof(TankerTask), nameof(TankerTask))]
[JsonDerivedType(typeof(FACTask), nameof(FACTask))]
[JsonDerivedType(typeof(SetROETask), nameof(SetROETask))]
[JsonDerivedType(typeof(SetReactionToThreatTask), nameof(SetReactionToThreatTask))]
[JsonDerivedType(typeof(SetRadarUsing), nameof(SetRadarUsing))]
[JsonDerivedType(typeof(SetFlareUsing), nameof(SetFlareUsing))]
[JsonDerivedType(typeof(SetECMUsing), nameof(SetECMUsing))]
[JsonDerivedType(typeof(SetMissileAttackRange), nameof(SetMissileAttackRange))]
[JsonDerivedType(typeof(SetRTBOnBingo), nameof(SetRTBOnBingo))]
[JsonDerivedType(typeof(SetRTBOnOutOfAMMO), nameof(SetRTBOnOutOfAMMO))]
[JsonDerivedType(typeof(SetSilence), nameof(SetSilence))]
[JsonDerivedType(typeof(SetProhibitAA), nameof(SetProhibitAA))]
[JsonDerivedType(typeof(SetProhibitJettison), nameof(SetProhibitJettison))]
[JsonDerivedType(typeof(SetProhibitAfterBurner), nameof(SetProhibitAfterBurner))]
[JsonDerivedType(typeof(SetProhibitAG), nameof(SetProhibitAG))]
[JsonDerivedType(typeof(SetProhibitWPPassReport), nameof(SetProhibitWPPassReport))]
[JsonDerivedType(typeof(SetProhibitRadioUsageContact), nameof(SetProhibitRadioUsageContact))]
[JsonDerivedType(typeof(SetProhibitRadioUsageEngage), nameof(SetProhibitRadioUsageEngage))]
[JsonDerivedType(typeof(SetProhibitRadioUsageKill), nameof(SetProhibitRadioUsageKill))]
[JsonDerivedType(typeof(SetJettisonTanksIfEmpty), nameof(SetJettisonTanksIfEmpty))]
[JsonDerivedType(typeof(SetForcedAttack), nameof(SetForcedAttack))]
[JsonDerivedType(typeof(SetAllowFormationSideSwap), nameof(SetAllowFormationSideSwap))]
